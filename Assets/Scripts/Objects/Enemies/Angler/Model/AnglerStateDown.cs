...
{
    public class AnglerStateDown : IEState
    {
        ...
        public AnglerStateDown(EnemyModel enemyModel, EnemyController enemyController, int attackCount, int summonCount)
        {
            eM = enemyModel;
            eC = enemyController;
        ...
        private async UniTask Down()
        {
            ...
            else eM.ChangeState(new AnglerStateFishing(eM, eC, attackCount, summonCount));
        }
